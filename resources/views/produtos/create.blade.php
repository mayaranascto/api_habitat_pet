...
<div class="container-fluid">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      {{ Form::open(['url' => '/produtos', 'method' => 'post', 'class' => 'form-horizontal ', 'enctype' => 'multipart/form-data'])}}
        <div class="form-group">
          {{ Form::label('nome_produto', 'Nome do Produto', ['class' => 'col-md-2 control-label'])}}
          <div class="col-md-10">
            {{ Form::text('nome_produto', '', ['class' => 'form-control', 'placeholder' => 'Nome do Produto']) }}
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-md-10">
            {{ Form::textarea('descricao_produto', '', ['class' => 'form-control', 'placeholder' => 'Descrição', 'rows' => '5']) }}
          </div>
        </div>
        <div class="form-group">
